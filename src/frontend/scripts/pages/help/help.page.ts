...
export class AidePage {
  ...
  public async render(): Promise<void> {
    ...
    const html = await renderTemplate(
      "/src/frontend/templates/pages/help-page.tpl.html",
      {}
    );
  ...
  private async renderFAQ(): Promise<void> {
    ...
    const faqTemplate = await renderTemplate(
      "/src/frontend/templates/pages/help/help-faq.tpl.html",
      {}
    );
  ...
  private async renderFAQItem(item: FAQItem): Promise<string> {
    return await renderTemplate(
      "/src/frontend/templates/pages/help/help-faq-item.tpl.html",
      {
        id: item.id,
  ...
  private async renderMentions(): Promise<void> {
    ...
    const template = await renderTemplate(
      "/src/frontend/templates/pages/help/help-legal.tpl.html",
      {}
    );
  ...
  private async renderRGPD(): Promise<void> {
    ...
    const template = await renderTemplate(
      "/src/frontend/templates/pages/help/help-privacy.tpl.html",
      {}
    );
    container.innerHTML = template;
  }
  ...
  private async renderContact(): Promise<void> {
    ...
    const template = await renderTemplate(
      "/src/frontend/templates/pages/help/help-contact.tpl.html",
      {}
    );
    container.innerHTML = template;
