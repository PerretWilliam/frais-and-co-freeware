...
export class FraisGlobauxPage {
  ...
  public async render(): Promise<void> {
    ...
    const html = await renderTemplate(
      "/src/frontend/templates/frais-globaux-page.tpl.html",
      {}
    );
  ...
  private async renderTable(): Promise<void> {
    ...
    if (this.filteredFrais.length === 0) {
      container.innerHTML = await renderTemplate(
        "/src/frontend/templates/frais-empty.tpl.html",
        {
    ...
    if (this.canValidate) {
      ...
      checkboxHeaderHtml = await renderTemplate(
        "/src/frontend/templates/checkbox-header.tpl.html",
        {
    ...
    const tableHtml = await renderTemplate(
      "/src/frontend/templates/frais-globaux-table.tpl.html",
      { checkboxHeaderHtml }
    );
  ...
  private async renderFraisRow(frais: Frais): Promise<string> {
    ...
    if (this.canValidate && frais.statut === "EnCours") {
      ...
      checkboxCellHtml = await renderTemplate(
        "/src/frontend/templates/checkbox-cell.tpl.html",
        {
          id: frais.id_frais,
    ...
    const actionsHtml = await renderTemplate(
      "/src/frontend/templates/frais-globaux-action-view.tpl.html",
      { id: frais.id_frais }
    );

    return await renderTemplate(
      "/src/frontend/templates/frais-globaux-row.tpl.html",
      {
        checkboxCellHtml,
        date,
  ...
  private async updateBulkActions(): Promise<void> {
    ...
    const html = await renderTemplate(
      "/src/frontend/templates/bulk-actions.tpl.html",
      {}
    );
  ...
  private async renderPaginationButtons(totalPages: number): Promise<void> {
    ...
    const html = await renderTemplate(
      "/src/frontend/templates/pagination-buttons.tpl.html",
      {
