...
import { FormSubmitHandler } from "./nouveau-frais-form-handlers";
...
export class NouveauFraisPage {
  ...
  public async render(): Promise<void> {
    ...
    const html = await renderTemplate(
      "/src/frontend/templates/nouveau-frais-page.tpl.html",
      {}
    );
  ...
  private async renderTabContent(): Promise<void> {
    ...
    if (this.currentTab === "DEPLACEMENT") {
      ...
      const html = await renderTemplate(
        "/src/frontend/templates/nouveau-frais-deplacement.tpl.html",
        {
          chantiersOptionsHtml,
          vehiculeDisplay,
          vehiculeWarningHtml: vehiculeWarning,
        }
      );
      ...
      const html = await renderTemplate(
        "/src/frontend/templates/nouveau-frais-repas.tpl.html",
        { chantiersOptionsHtml }
      );
      container.innerHTML = html;
      ...
      const html = await renderTemplate(
        "/src/frontend/templates/nouveau-frais-hebergement.tpl.html",
        { chantiersOptionsHtml }
      );
      container.innerHTML = html;
  ...
  private async renderHistoryItem(
    ...
    return await renderTemplate(
      "/src/frontend/templates/nouveau-frais-history-item.tpl.html",
      {
